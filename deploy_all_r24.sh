#!/bin/bash
# 部署 luci-app-pushbot r24 到所有第一批终端

TERMINALS="10.1.0.1 10.2.0.1 10.3.0.1 10.12.0.1 10.13.0.1 10.101.0.1 10.102.0.1 10.103.0.1 10.104.0.1"
MAIN_APK="/home/zed/coding/openwrt/luci-app-pushbot/luci-app-pushbot-5.17-r24.apk"
I18N_APK="/home/zed/coding/openwrt/luci-app-pushbot/luci-i18n-pushbot-zh-cn-5.17-r24.apk"
